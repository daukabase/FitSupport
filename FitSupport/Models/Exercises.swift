...
class Exercises {
    ...
    static private var allExercises: [Exercise] = [
        ...
        Exercise(id: "ABS004", name: "Поднятие ног", image: UIImage.gif(name: "ABS004"), muscleType: [.abs], trainingSession: TrainingSession(reps: 4, times: 30)),
...
//        Exercise(id: "ARM001", name: "Жим штанги лежа", image: UIImage.gif(name: "ARM001"), muscleType: [.arm, .chest], trainingSession: TrainingSession(reps: 5, times: 6)),
        ...
        Exercise(id: "ARM011", name: "Сгибания рук со штангой", image: UIImage.gif(name: "ARM011"), muscleType: [.arm], trainingSession: TrainingSession(reps: 8, times: 5)),
...
//        Exercise(id: "ARM013", name: "Французкий жим в тренажере", image: UIImage.gif(name: "ARM013"), muscleType: [.arm], trainingSession: TrainingSession(reps: 12, times: 6)),
        ...
        Exercise(id: "SH003", name: "Жим в тренажере на плечи", image: UIImage.gif(name: "SH003"), muscleType: [.shoulders], trainingSession: TrainingSession(reps: 8, times: 4)),
        Exercise(id: "SH004", name: "Жим гантелей сидя", image: UIImage.gif(name: "SH004"), muscleType: [.shoulders], trainingSession: TrainingSession(reps: 12, times: 3)),
        ...
        Exercise(id: "CH005", name: "Жим лежа на наклонной скамье", image: UIImage.gif(name: "CH005"), muscleType: [.chest], trainingSession: TrainingSession(reps: 8, times: 5)),
...
//        Exercise(id: "B004", name: "Разведение рук с тросом", image: UIImage.gif(name: "B004"), muscleType: [.back], trainingSession: TrainingSession(reps: 10, times: 4)),
        ...
        Exercise(id: "L001", name: "Выпады со штангой", image: UIImage.gif(name: "L001"), muscleType: [.leg], trainingSession: TrainingSession(reps: 8, times: 4)),
